...
export default function CancelOrder() {
                        ...
                        <div className="w-[300px]">
                            <div className="grid grid-flow-row h-auto">
                                ...
                                <div className="bg-white border-2 h-auto rounded-lg py-2 px-3 grid grid-flow-row w-[300px]">
                                    <span className="text-black text-lg font-bold mb-2">Rp0</span>
                                    <div className="flex flex-wrap gap-2 h-auto mb-1">
                                        <span className="bg-red-500 p-1 px-3 text-sm text-white rounded-md">Unpaid</span>
    ...
    return (
        <>
            <div className="font-bold text-3xl border-b border-[#2125291A] h-16 mb-7">Cancel Order</div>
