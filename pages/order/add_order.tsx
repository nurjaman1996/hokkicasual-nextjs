                ...
                list_product.push(
                    <div key={index}>
                        <div
                            ...
                            className=" bg-white h-fit shadow-md cursor-pointer rounded-lg pb-1">
                            <Image
        ...
        <>
            ...
            <div className="grid grid-cols-[1fr_33%] h-full w-full">
                <div className="h-full flex flex-col">
                    {addmodal ? (
                        <div
                            ...
                            <div className="mt-[10%] mx-auto w-[70%] h-fit bg-white rounded-lg grid grid-cols-[40%_1fr]">
                                <div className="p-5 mt-2">
                                    <div>
                                        <Image
                                            className="w-[100%] h-auto m-auto rounded-lg"
                                            src={`https://buwanais.co.id/apiupload/${addmodal_img}`}
                                            alt="Picture of the author"
                                            width={300}
                                            height={300}
                                        />
                                ...
                                <div className="flex flex-col gap-2 border-l p-5 mt-2">
                                    ...
                                    <div className="text-sm border-b pb-2 mb-1">
                                        <div className="font-medium line-clamp-2">{addmodal_produk}</div>
                                    </div>
                ...
                <div className="bg-white h-full py-5 px-4 flex flex-col gap-2 z-10">
                    <div className="h-[5vh] border-b">
                        <span className="font-bold text-lg">Detail Items</span>
                    </div>
